...
object EdgePropGCNExample {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val edgeFeatureInput = params.getOrElse("edgeFeaturePath", "")
    ...
    val features = IOFunctions.loadFeature(edgeInput, sep = "\t")
    val edgeFeatures = IOFunctions.loadEdgeFeature(edgeFeatureInput, sep = "\t")
