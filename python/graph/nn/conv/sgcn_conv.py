...
class SGCNConv(torch.jit.ScriptModule):
    ...
    def __init__(self,
        ...
        self.weight = Parameter(torch.Tensor(in_channels, out_channels))#保留全连接层
...
class SGCNConv2(torch.jit.ScriptModule):
    '''
    SGCNConv2 is designed for distributed mini-batch training.
    '''

    def __init__(self,
                 in_channels,
                 out_channels):
        super(SGCNConv2, self).__init__()
