...
#define TIMER_NSEC(_X)                                                         \
  std::chrono::duration_cast<std::chrono::nanoseconds>(_X##_stop - _X##_start) \
      .count()
#define TIMER_USEC(_X)                                                         \
  std::chrono::duration_cast<std::chrono::microseconds>(_X##_stop -            \
                                                        _X##_start)            \
      .count()
#define TIMER_MSEC(_X) 0.000001 * TIMER_NSEC(_X)
#define TIMER_SEC(_X) 0.000001 * TIMER_USEC(_X)
